...
const SelectFavoriteScreen = () => {
    ...
    try {
      ...
      if (json.status === 'OK' && json.result) {
        ...
        if (field === 'pickup') {
          ...
          navigation.navigate('FavoriteMap',
            {
  ...
  const handleMapButton = () => {
    navigation.navigate('FavoriteMap', { phoneNumber });
  };
    ...
    <View style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      >
        ...
        <View style={styles.header}>
          <TouchableOpacity onPress={() => navigation.navigate('SelectLocation', { phoneNumber })}>
            <Entypo name="cross" size={22} color="black" />
          </TouchableOpacity>
          <Text style={styles.title}>Save Your Favorite Location</Text>
        </View>
        {/* Pickup input */}
            ...
            onPress={() => {
              if (selectedPickup) {
                navigation.navigate('SelectLocation', {
                  phoneNumber,
                  pickup: selectedPickup, // Make sure this is passed
                  pickupName: pickup,
                });
              }
            }}
