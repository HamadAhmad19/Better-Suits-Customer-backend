...
const SaveHomeScreen = () => {
  ...
  const handleMapButton = () => {
    navigation.navigate('HomeLocation', { phoneNumber });
  };
    ...
    <View style={{ flex: 1, backgroundColor: '#fff' }}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Save Your Home Location</Text>
        </View>
        {/* Pickup input */}
        ...
        <TouchableOpacity style={styles.currentLocationButton} onPress={handleCurrentLocation}>
          <View style={styles.currentLocationIconBox}>
            <MaterialIcons name="my-location" size={20} color="#0254E8" />
          </View>
