...
const DropoffLaterScreen = () => {
  ...
  console.log('DropoffLaterScreen params:', route.params);
      ...
      <View style={styles.searchSection}>
        ...
        >
          <Text style={styles.confirmButtonText}>
            {isLoadingAddress ? 'Getting Location...' : 'Confirm drop-off Location'}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
...
export default DropoffLaterScreen;