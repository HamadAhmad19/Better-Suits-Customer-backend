...
import { saveWorkLocation } from '../services/apiService';
...
const WorkLocationScreen = () => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const success = await saveWorkLocation(phoneNumber, locationData);
      ...
      if (success) {
        ...
        Alert.alert('Error', 'Failed to save work location');
      }
    } catch (error) {
      ...
      <View style={styles.searchSection}>
        ...
        >
          <Text style={styles.confirmButtonText}>
            {isLoadingAddress ? 'Getting Location...' : 'Save Work Location'}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
