...
import { saveHomeLocation } from '../services/apiService';
...
const HomeLocationScreen = () => {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      const success = await saveHomeLocation(phoneNumber, locationData);
      ...
      <View style={styles.searchSection}>
        ...
        <TouchableOpacity
          style={[
            ...
            (!selectedLocation || isLoadingAddress || isSaving) && styles.confirmButtonDisabled,
          ]}
          onPress={handleConfirm}
          disabled={!selectedLocation || isLoadingAddress || isSaving}
        >
          <Text style={styles.confirmButtonText}>
            {isSaving ? 'Saving...' : (isLoadingAddress ? 'Getting Location...' : 'Save Home Location')}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
