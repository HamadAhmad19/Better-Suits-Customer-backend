...
const FavoriteMapScreen = () => {
  const navigation = useNavigation();
  const route = useRoute();
  const { selectedLocation: initialLocation, locationName: initialLocationName, phoneNumber: phoneNumber } = route.params || {};
      ...
      <View style={styles.searchSection}>
        ...
        >
          <Text style={styles.confirmButtonText}>
            {isLoadingAddress ? 'Getting Location...' : 'Save Favorite Location'}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
...
export default FavoriteMapScreen;