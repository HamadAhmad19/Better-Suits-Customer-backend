...
const RecipentScreen = () => {
    ...
    // Receive pickup from SenderScreen
  ...
  return (
    ...
    style={[
      ...
      (!selectedDropoff) && styles.confirmButtonDisabled,
    ]}
    onPress={() => {
      if (selectedDropoff) {
        navigation.navigate('RecipentAddress', {
          pickup: pickup, // Pass pickup forward
          dropoff: selectedDropoff, // Pass dropoff
        });
      }
    }}
